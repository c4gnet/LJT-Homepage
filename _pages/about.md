...
I am a first-year Ph.D. candidate at the HKUST NLP Group, Hong Kong University of Science and Technology, advised by Prof. Junxian He. My research focuses on natural language processing and machine learning. I received my B.Eng. from Shanghai Jiao Tong University in June 2024.
...
For full details, see the [Publications](/publications/) page.

1. **SynLogic: Synthesizing Verifiable Reasoning Data at Scale for Learning Logical Reasoning and Beyond**. *arXiv preprint, 2025*. (First author)
...
2. **On the Perception Bottleneck of VLMs for Chart Understanding**. *arXiv preprint, 2025*. (First author)
